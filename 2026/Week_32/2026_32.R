## Challenge: #MakeoverMonday 2026 week 32
## Data:      Met Office Average Air Temperatures
## Author:    Steven Ponce
## Date:      2026-08-10
...
## 2. READ IN THE DATA ----
df_raw <- read_csv(
  "data/2026/met_office_uk_mean_temps.csv") |>
  clean_names()
...
## |- Preview ----
p +
  ggview::canvas(width = 8, height = 6, units = "in")
...
save_ggplot(
  plot = p,
  file = here::here("2026", "Week_32", "2026_32.png"),
